교재(도커&쿠버네티스)의 p.24-52까지 실행해봤는데 이거는 예정 방식이래서 안적었어요 ㅎ 몰라도 됩니다.
...
터미널:<br />
docker rm -f web (기존꺼 지우고)<br />
docker build -t react:0.1 .<br />
docker run -d -p 80:80 --name web react:0.1<br />

새로 build 해주고 화면 잘 뜨는지 확인<br />
